...
function calcsgpa($papers){
        ...
        foreach($papers as $paper){
            ...
            $insertRecord = "INSERT INTO `studentfinalresult` (`HALLTICKET`, `S1GPA`, `S2GPA`, `S3GPA`, `S4GPA`, `S5GPA`, `S6GPA`, `PART1GPA`, `PART2GPA`, `OVERALLGPA`, `PART1TOTAL`, `PART2TOTAL`, `OVERALLTOTAL`) VALUES (".$_GET['hallticket'].", "
            . $sgpa['sem1'] .", "
            . $sgpa['sem2'] .", "
            . $sgpa['sem3'] .", "
            . $sgpa['sem4'] .", "
            ...
            $updated=$conn->query($insertRecord);
