...
<!--?php echo basename(__FILE__);?-->
 <form action="revaluetemplate.php" method="post" onsubmit="return validate();">

  <div class="row">
<div class="col-md-3">
<div class="form-group">   
     <input type="hidden" name="extype" value="REVALUATION">
</div>
</div>
</div>
          ...
          <div id="formcontent">
              ...
              <strong><h5 class="text-danger"></h5></strong>
           </div>
           <div id="E1">
        ...
        xhr.onreadystatechange=function(){
            ...
            papers.forEach(paper=> {
                if(paper.PAPERGROUP=="E1"){
                    ...
                    e1.innerHTML+= '<input type="radio" name="E1"   value="'+paper.PAPERCODE+':'+paper.PAPERNAME+'">'+paper.PAPERCODE+':'+paper.PAPERNAME;
                }
