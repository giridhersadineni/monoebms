...
<?php
include "../library/projectorm.php";


$sql = "select * from  examenrollments where EID=".$_GET['eid'];
...
<?php
$examname="select * from examsmaster where EXID=". $row['EXAMID'];
//echo $examname;
$exam= $conn->query($examname);
$ename=mysqli_fetch_assoc($exam);

$student="select * from students where stid=". $row['STUDENTID'];
//echo $student;
$studentdetails= $conn->query($student);
$sname=mysqli_fetch_assoc($studentdetails);
...
<span>Name of the student: <?php echo $sname["sname"] ?></span> <br>
          <p >Class: <?php echo $sname["course"] ?></p>
          <p>H.T.No: <?php echo $sname["haltckt"] ?></p>
          
        
     <p>Name of Exam & Year:<?php echo $ename['EXAMNAME']?>  </p>
...
<div class="ex0">TRIPLICATE</div>            
    ...
    <p>  Date </p>
           ...
           <span>Name of the student: <?php echo $sname["sname"] ?></span> 
           <p >Class: <?php echo $sname["course"] ?></p>
                    <p>H.T.No:<?php echo $sname["haltckt"] ?></p>
                    <p>Name of Exam & Year:<?php echo $ename["EXAMNAME"]?> </p>
