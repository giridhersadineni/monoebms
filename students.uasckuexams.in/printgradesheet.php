...
$studentgpa="select * from gpas where HALLTICKET=$hallticket and EXAMID=$examid";
...
$sql = "select * from  rholdernew where EXAMID=".$_GET['id']." and HALLTICKET=".$_GET['ht'] .' ORDER BY CREDITS DESC';
//echo $sql;
