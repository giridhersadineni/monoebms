...
if (isset($_POST["submit"])) {
    ...
    $values = "'" . $subsquery . "','" . $e1 . "','" . $e2 . "','" . $e3 . "','" . $e4 . "','";
    $sql = "INSERT INTO examenrollments ( EXAMID, STUDENTID, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, E1, E2, E3, E4,FEEAMOUNT,ENROLLEDDATE) VALUES (" . $_POST['examid'] . "," . $student['stid'] . "," . $values . $_POST["fee"] . "', CURRENT_TIMESTAMP)";
