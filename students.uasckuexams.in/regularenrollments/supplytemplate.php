...
if ($_POST['extype'] == "SUPPLY" && $_POST['course'] == "BSC") {
    if ($count > 2) {
        $fee = 950;
        echo '<input type="hidden" name="fee" value="650"></input>';

    } else {
        $fee = 850;
        echo '<input type="hidden" name="fee" value="550"></input>';

    }
}
if ($_POST['extype'] == "SUPPLY" && $_POST['course'] == "BA") {
    if ($count > 2) {
        $fee = 850;
        echo '<input type="hidden" name="fee" value="550"></input>';
        ...
        $fee = 750;
        echo '<input type="hidden" name="fee" value="450"></input>';

    }
}
if ($_POST['extype'] == "SUPPLY" && $_POST['course'] == "BCOM") {
    if ($count > 2) {
        $fee = 950;
        echo '<input type="hidden" name="fee" value="650"></input>';
...
if ($_POST['extype'] == "SUPPLY" && $_POST['course'] == "BCOM" && $_POST['GROUP']='GEN') {
    if ($count > 2) {
        $fee = 550;
        echo '<input type="hidden" name="fee" value="650"></input>';
...
?>
 ...
 <a  href="examenrollsupply.php?<?php echo "examid=" . $_POST['examid'] . "&course=" . $_POST['course'] . "&group=" . $_POST['group'] . "&medium=" . $_POST['medium'] . "&semester=" . $_POST['semester'] . "&et=" . $_POST['extype']; ?>" class="btn btn-warning" >Back</a>
