...
$sql = "select * from  RESULTS_STAGE where EXAMID=".$_GET['exid']." and HALLTICKET=".$_GET['ht'];
//echo $sql;

$studentgpa="select * from `GPAS_STAGE` where HALLTICKET='".$_GET['ht']."' and EXAMID=".$_GET['exid']."";
//echo $studentgpa;
 ...
 { 
   ...
   // print_r($row);
    //echo "<br>";
        ...
        // echo "<td style=padding-right:4cm;font-size:12px; margin-bottom:0px;>".strtoupper($row['PAPERCODE'])."</td>";
