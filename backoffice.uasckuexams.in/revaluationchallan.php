...
$sql = "select * from  revaluationenrollments where ID=" . $_GET['id'];



$row = get_one_assoc($sql);
...
<?php
$getexamdetails="select * from examsmaster where EXID=". $row['EXAMID'];
$exam=get_one_assoc($getexamdetails);  

$getstudentdetails="select * from students where stid=". $row['STUDENTID'];
$sname=get_one_assoc($getstudentdetails);
...
<span>Name of the student: <?php echo $sname["sname"] ?></span> <br>
     ...
     <p>Name of Exam & Year:<?php echo $exam['EXAMNAME']?>  </p>
      <p>RE-EVALUATION</p>          
