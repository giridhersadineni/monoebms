...
#formcontent, #E1, #E2, #E3, #E4,#E5,#feedetails{
    margin:10px;
    padding:10px;
...
<!--?php echo basename(__FILE__);?-->
 <form action="suptemplate.php" method="post" onsubmit="return validate();">
...
<select name="extype"    class="form-control" required>
    ...
    <script>
        ...
        var url="../api/course/getsubjects.php?scheme=<?php echo $_GET['scheme']?>&course=<?php echo $_GET['course']; ?>&group=<?php echo $_GET['group']; ?>&medium=<?php echo $_GET['medium']; ?>&semester=<?php echo $_GET['semester']; ?>";
        console.log(url);
        ...
        xhr.onreadystatechange=function(){
            ...
            papers.forEach(paper=> {
                if(paper.PAPERGROUP=="E1"){
                    e1.innerHTML+= '<input type="radio" name="E1"   value="'+paper.PAPERCODE+':'+paper.PAPERNAME+'">'+paper.PAPERCODE+':'+paper.PAPERNAME+ '</input><br>';
                }
                    ...
                    e5.innerHTML+= '<input type="radio" name="E5"  value="'+paper.PAPERCODE+':'+paper.PAPERNAME+'">'+paper.PAPERCODE+" "+paper.PAPERNAME+'</input><br>';
                }
                else{
