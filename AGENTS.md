...
|---|---|---|
| `skills/Codex/SKILL.md` | Codex (Codex.ai) | Codex-driven tasks referencing `.agents/AGENTS.md` or Codex-specific reporting style |
| `skills/Codex/SKILL.md` | Codex | Any code change inside `monoebms` via Codex CLI |
...
**In Codex** — skills are picked up automatically when you open the repo. The agent reads `AGENTS.md` first, then loads the relevant skill when the task matches its description. No manual step required.

**In Codex (Cowork / Codex.ai)** — install a skill by opening the `.skill` package in the Codex desktop app, or point the agent at the `SKILL.md` path. Once installed, Codex loads it whenever the trigger conditions in the description match your request.
...
|----------|------|---------|
| Codex (Codex.ai) | `skills/Codex/SKILL.md` | Codex workflows — migration & security tasks |
| Codex (CLI) | `skills/Codex/SKILL.md` | Codex CLI workflows |
...
- **Codex / Codex**: The file is referenced via `skills:` in `.Codex/settings.json` or read manually at session start.
