...
@section('title', 'D-Form Generation')

@section('content')
<div class="max-w-lg">
    <div class="mb-6">
        <h1 class="text-xl font-semibold text-slate-800">D-Form Generation</h1>
        <p class="text-sm text-slate-500 mt-0.5">Select a subject and exam to generate the hall-ticket list.</p>
    </div>

    <form action="{{ route('admin.dform.print') }}" method="GET" target="_blank"
